...
#
##################################################################################################################################
XL7_Processa_compra <- function(cliente=2,puser="cedot",pdir="C:/Users/cdottori/OneDrive/XL7 COMPARTILHADA/Desconto Popular/"){
      ...
      setwd(paste0(pdir,"/compra_historica"))
      path <- paste0(pdir,"/compra_historica")
